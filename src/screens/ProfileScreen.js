...
import { PROFILE_ITEMS_METADATA } from '../constants';
...
const ProfileItem = props => (
  <TouchableOpacity style={[styles.profileRow]} onPress={props.onPress}>
    <View style={styles.titleView}>
      <Text style={[styles.title, props.titleStyle]}>{props.title}</Text>
    </View>
    <View style={styles.profileItemRow}>
      <View style={styles.profileItemNameView}>
        <Text style={styles.profileItemText}>{props.value}</Text>
      </View>
  ...
  return (
    <View>
      <View style={styles.screenTitleView}>
        <Text style={styles.screenTitleText}>Edit Profile</Text>
      </View>
          ...
          <TouchableOpacity
            ...
            style={[
              ...
              props.profileImageUri
                ? {}
                : { borderColor: '#006aff', borderWidth: 1 },
            ]}
          >
